...
public class App {
	 ...
	 * @param accessSecret
	 */
	public App(String appToken, String appSecret, String accessToken, String accessSecret) {
	...
	public static void main(String[] args) {
		...
		App app = new App(mkmAppToken, mkmAppSecret, mkmAccessToken, mkmAccessTokenSecret);
		app.setDebug(true);
		if (app.request("https://www.mkmapi.eu/ws/v2.0/users/caesar")) {
